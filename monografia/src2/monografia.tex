...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Huge{Computação Verde na \\ \vspace{5mm} Camada de Aplicação}}\\
    ...
    \vskip 4.0cm
    \LARGE{Thales Areco Bandiera Paiva} \\
    \LARGE{Orientador: Prof. Dr. Alfredo Goldman vel Lejbman} \\

    %\vskip 1.0cm
    \vfill
    \Large{São Paulo, dezembro de 2014}
\end{center}
...
\input cap-computacao_verde  % associado ao arquivo: 'cap-conceitos.tex'
\input cap-eficiencia_energetica  % associado ao arquivo: 'cap-conceitos.tex'
\input cap-metodologia_medicao  % associado ao arquivo: 'cap-conceitos.tex'
\input cap-experimentos  % associado ao arquivo: 'cap-conceitos.tex'
